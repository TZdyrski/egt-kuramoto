\begin{tikzpicture}
  \begin{groupplot}[
    ...
    \nextgroupplot
        ...
        \node [text width=1cm,anchor=north west] at (rel axis cs: 0,1) {\subcaption{\label{fig:game-type_well-mixed}}};
      \nextgroupplot
        % Note: this table names must appear in the `\tablename` loop below
        ...
        \node [text width=1cm,anchor=north west] at (rel axis cs: 0,1) {\subcaption{\label{fig:game-type_celegans-full}}};
    \end{groupplot}
