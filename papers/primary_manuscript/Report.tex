...
\Cref{fig:graph} shows the $N = 300$ nodes and the directed edges.
...
One of the key aspects of the Evolutionary Kuramoto Theory
...
This is a feature of the average degree of the different graphs.
...
While the number of players $N = 300$ is much larger than the well-mixed case,
the average indegree $d_{in}$ is smaller (\num{13.36} \vs \num{19}).
Therefore, if we consider the \gls{celegans} connectome game
