...
\begin{adjustwidth}{-2.25in}{0in}
  ...
  \caption{
    ...
    $\alpha \in [0,0.25,0.5,0.75,1]$.
		\protect{\subref{fig:phase-diagram-table}}
    ...
    \protect{\subref{fig:phase-diagram-beta_alpha}}.
		...
		with $B_0/c$ corresponding to white dots on \protect{\subref{fig:phase-diagram-beta_B}}
...
\begin{adjustwidth}{-2.25in}{0in}
  ...
  \caption{
    ...
    \protect{\subref{fig:sensitivity-analysis-beta}}
		maximum mixed benefit to maximum joint benefit ratio
		$\beta_0/B_0$,
    \protect{\subref{fig:sensitivity-analysis-B}}
		maximum joint benefit to cost ratio $B_0/c$,
    \protect{\subref{fig:sensitivity-analysis-m}}
		number of phases $m$,
    \protect{\subref{fig:sensitivity-analysis-delta}}
		selection strength $\delta$,
		and
    \protect{\subref{fig:sensitivity-analysis-T}}
...
to changes in
\subref{fig:sensitivity-analysis-beta}
maximum mixed benefit to maximum joint benefit ratio
$\beta_0/B_0$,
\subref{fig:sensitivity-analysis-B}
maximum joint benefit to cost ratio $B_0/c$,
\subref{fig:sensitivity-analysis-m}
number of phases $m$,
\subref{fig:sensitivity-analysis-delta}
selection strength $\delta$,
and
\subref{fig:sensitivity-analysis-T}
simulation run time $T$.
