...
While the well-mixed case is rarely disordered (non ``all-C''/``all-N''),
the non-synchronized staghunt and concord games
do occur roughly \SI{20}{\percent} of the time as a fraction of the
disordered games in \cref{fig:game-type_well-mixed-only-mixed-games}.
