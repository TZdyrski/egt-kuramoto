...
\etc{}~\citep[\cf{}][for definitions]{bruns2015names}.
...
still mostly displays the nearly-synchronized hero-type game
...
with $\rho = 1$ for completely coherent and $\rho = 0$ completely disordered.

\subsubsection{Chimera-like index and metastability index}
