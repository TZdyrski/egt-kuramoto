...
\begin{tikzpicture}[x=0.3cm,y=0.3cm]
  \matrix{
    \begin{scope}[scale=10]
      ...
      \csvreader[head to column names]{\dataSearchPath/graph_structure/vertices_adj_matrix_source=well-mixed.csv}{}%
      {%
    ...
    \begin{scope}[on background layer]
      ...
      % Read edges and draw connections between nodes
        \csvreader[head to column names]{\dataSearchPath/graph_structure/edges_adj_matrix_source=well-mixed.csv}{}%
      {%
