...
at least \num{155}, \ie{} $\sum_i K_{i,j} \ge 155$.
Note that \num{155} is chosen as a high cutoff
to ensure we only group nodes with high covariance-sum;
for reference, \num{155} is is approximately \SI{80}{\percent}
of the maximum covariance-sum and splits the population into
communities of size \num{81} and \num{219}.
