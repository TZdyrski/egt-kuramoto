...
rule manuscript:
  ...
  input:
    ...
    "data/processed/timeseries_statistics/B_to_c=1.5_adj_matrix_source=c-elegans_beta_to_B=0.95_cost=0.1_early_cutoff_fraction=0.1_exclude_CC_NN=false_exclude_synchronized=false_mutation_rate=0.0001_nb_phases=20_selection_strength=0.2_symmetry_breaking=0.75_time_steps=8000000.csv",
    ...
    "data/processed/gametype/B_to_c=1.5_adj_matrix_source=well-mixed_beta_to_B=0.95_cost=0.1_exclude_CC_NN=false_exclude_synchronized=false_mutation_rate=0.0001_nb_phases=20_nb_players=20_selection_strength=0.2_time_steps=8000000.csv",
    "data/processed/gametype/B_to_c=1.5_adj_matrix_source=well-mixed_beta_to_B=0.95_cost=0.1_exclude_CC_NN=true_exclude_synchronized=true_mutation_rate=0.0001_nb_phases=20_nb_players=20_selection_strength=0.2_time_steps=8000000.csv",
    "data/processed/gametype/B_to_c=1.5_adj_matrix_source=c-elegans_beta_to_B=0.95_cost=0.1_exclude_CC_NN=false_exclude_synchronized=false_mutation_rate=0.0001_nb_phases=20_selection_strength=0.2_time_steps=8000000.csv",
    "data/processed/gametype/B_to_c=1.5_adj_matrix_source=c-elegans_beta_to_B=0.95_cost=0.1_exclude_CC_NN=true_exclude_synchronized=true_mutation_rate=0.0001_nb_phases=20_selection_strength=0.2_time_steps=8000000.csv",
    ...
    "data/processed/timeseries_statistics/B_to_c=1.5_adj_matrix_source=well-mixed_beta_to_B=0.95_cost=0.1_early_cutoff_fraction=0.1_exclude_CC_NN=false_exclude_synchronized=false_mutation_rate=0.0001_nb_phases=20_nb_players=20_selection_strength=0.2_symmetry_breaking=0.0_time_steps=8000000.csv",
    "data/processed/timeseries_statistics/B_to_c=1.5_adj_matrix_source=well-mixed_beta_to_B=0.95_cost=0.1_early_cutoff_fraction=0.1_exclude_CC_NN=false_exclude_synchronized=false_mutation_rate=0.0001_nb_phases=20_nb_players=20_selection_strength=0.2_symmetry_breaking=0.75_time_steps=8000000.csv",
    "data/processed/timeseries_statistics/B_to_c=1.5_adj_matrix_source=well-mixed_beta_to_B=0.95_cost=0.1_early_cutoff_fraction=0.1_exclude_CC_NN=false_exclude_synchronized=false_mutation_rate=0.0001_nb_phases=20_nb_players=20_selection_strength=0.2_symmetry_breaking=1.0_time_steps=8000000.csv",
...
rule processed_timeseries_statistics:
  ...
  input:
    ...
    "data/raw/timeseries/B_to_c={B_to_c}_adj_matrix_source={adj_matrix_source}_beta_to_B={beta_to_B}_cost={cost}_mutation_rate={mutation_rate}_nb_phases={nb_phases}{nb_players_flag}{nb_players}_selection_strength={selection_strength}_symmetry_breaking={symmetry_breaking}_time_steps={time_steps}.jld2",
  output:
    "data/processed/timeseries_statistics/B_to_c={B_to_c}_adj_matrix_source={adj_matrix_source}_beta_to_B={beta_to_B}_cost={cost}{early_cutoff_fraction_flag}{early_cutoff_fraction}_exclude_CC_NN={exclude_CC_NN}_exclude_synchronized={exclude_synchronized}_mutation_rate={mutation_rate}_nb_phases={nb_phases}{nb_players_flag}{nb_players}_selection_strength={selection_strength}_symmetry_breaking={symmetry_breaking}_time_steps={time_steps}.csv",
  script:
    "scripts/snakemake/postprocess_timeseries_statistics.jl"
...
rule processed_game_types:
  ...
  output:
    "data/processed/gametype/B_to_c={B_to_c}_adj_matrix_source={adj_matrix_source}_beta_to_B={beta_to_B}_cost={cost}_exclude_CC_NN={exclude_CC_NN}_exclude_synchronized={exclude_synchronized}_mutation_rate={mutation_rate}_nb_phases={nb_phases}{nb_players_flag}{nb_players}_selection_strength={selection_strength}_time_steps={time_steps}.csv",
  script:
    "scripts/snakemake/postprocess_game_types.jl"
