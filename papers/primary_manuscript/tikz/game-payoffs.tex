  ...
  \begin{groupplot}[
    ...
    \pgfplotstableforeachcolumn\gameData\as\game{%
      ...
      \noexpand\ifthenelse{\rowC < \rowA \noexpand\AND \colB < \colA}{
        \noexpand\node[circle,draw=black,fill=black,above,label=A] (A) at (\rowA,\colA) {};
      }{
        \noexpand\node[circle,draw=black,fill=white,above,label=A] (A) at (\rowA,\colA) {};
      }
      \noexpand\ifthenelse{\rowD < \rowB \noexpand\AND \colA < \colB}{
        \noexpand\node[circle,draw=black,fill=black,label=B] (B) at (\rowB,\colB) {};
      }{
        \noexpand\node[circle,draw=black,fill=white,label=B] (B) at (\rowB,\colB) {};
      }
      \noexpand\ifthenelse{\rowA < \rowC \noexpand\AND \colD < \colC}{
        \noexpand\node[circle,draw=black,fill=black,label=C] (C) at (\rowC,\colC) {};
      }{
        \noexpand\node[circle,draw=black,fill=white,label=C] (C) at (\rowC,\colC) {};
      }
      \noexpand\ifthenelse{\rowB < \rowD \noexpand\AND \colC < \colD}{
        \noexpand\node[circle,draw=black,fill=black,label=D] (D) at (\rowD,\colD) {};
      }{
        \noexpand\node[circle,draw=black,fill=white,label=D] (D) at (\rowD,\colD) {};
      }
