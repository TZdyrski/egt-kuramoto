...
\begin{tikzpicture}
  \begin{groupplot}[
    ...
    \nextgroupplot[xticklabel=\empty, ymin=0.99, ymax=1.0, height=3cm, blue,
      yticklabel style={/pgf/number format/.cd,precision=3}
    ]
        % Note: this table names must appear in the `\tablename` loop below
        \pgfplotstableread{../../data/processed/gametype/B_to_c=1.5_adj_matrix_source=well-mixed_beta_to_B=0.95_cost=0.1_mutation_rate=0.0001_nb_phases=20_nb_players=20_selection_strength=0.2_time_steps=8000000.csv}{\loadtable}
    ...
    \nextgroupplot[hide axis, height=3cm]
    \nextgroupplot
        % Note: this table names must appear in the `\tablename` loop below
        \pgfplotstableread{../../data/processed/gametype/B_to_c=1.5_adj_matrix_source=well-mixed_beta_to_B=0.95_cost=0.1_mutation_rate=0.0001_nb_phases=20_nb_players=20_selection_strength=0.2_time_steps=8000000.csv}{\loadtable}
        \pgfplotstableforeachcolumn\loadtable\as\col
      ...
      \nextgroupplot
        % Note: this table names must appear in the `\tablename` loop below
        \pgfplotstableread{../../data/processed/gametype/B_to_c=1.5_adj_matrix_source=c-elegans_beta_to_B=0.95_cost=0.1_mutation_rate=0.0001_nb_phases=20_selection_strength=0.2_time_steps=8000000.csv}\loadtable
        \pgfplotstableforeachcolumn\loadtable\as\col
        {
          \ifnum\pgfplotstablecol=0\else%
            \expandafter\addplot\expandafter[\col,ybar stacked,draw=none] table[x=asymmetry, y=\col] {\loadtable};
    ...
    \begin{axis}[
      ...
      \pgfplotsforeachungrouped\tablename in {../../data/processed/gametype/B_to_c=1.5_adj_matrix_source=well-mixed_beta_to_B=0.95_cost=0.1_mutation_rate=0.0001_nb_phases=20_nb_players=20_selection_strength=0.2_time_steps=8000000.csv,../../data/processed/gametype/B_to_c=1.5_adj_matrix_source=c-elegans_beta_to_B=0.95_cost=0.1_mutation_rate=0.0001_nb_phases=20_selection_strength=0.2_time_steps=8000000.csv} {
        % Read table
    ...
    \end{axis}
    \draw[blue] (group c1r1.south) -- (group c1r2.north);
