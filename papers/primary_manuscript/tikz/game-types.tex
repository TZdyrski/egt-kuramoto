  ...
  \begin{groupplot}[
    ...
    \nextgroupplot[xticklabel=\empty, ymin=0.99, ymax=1.0, height=3cm, blue,
      yticklabel style={/pgf/number format/.cd,precision=3}
        ...
        \pgfplotstableread{../../data/processed/gametype/B_to_c=1.5_adj_matrix_source=well-mixed_beta_to_B=0.95_cost=0.1_mutation_rate=0.0001_nb_phases=20_selection_strength=0.2_time_steps=8000000.csv}{\loadtable}
