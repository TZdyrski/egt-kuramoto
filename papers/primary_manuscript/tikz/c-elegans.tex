...
\begin{tikzpicture}
  \begin{scope}[rotate=90]
    ...
    \csvreader[head to column names]{../../data/processed/graph_structure/vertices_B_factor=1.5_adj_matrix_source=c-elegans_nb_phases=20_selection_strength=0.2_symmetry_breaking=0.75_time_step=560000_time_steps=8000000.csv}{}%
    {%
  ...
  \begin{groupplot}[
    ...
    y tick label style=blue,
      ...
      \nextgroupplot
        \addplot table{../../data/processed/cumulative/adj_matrix_source=c-elegans_nb_phases=20_selection_strength=0.2_symmetry_breaking=0.75_time_steps=200000000_type=simulation.csv};
      \nextgroupplot
        \addplot table{../../data/processed/cumulative/adj_matrix_source=c-elegans-unweighted_nb_phases=20_selection_strength=0.2_symmetry_breaking=0.75_time_steps=200000000_type=simulation.csv};
      \nextgroupplot[xlabel={Maximum joint benefit $B_0$}]
        \addplot table{../../data/processed/cumulative/adj_matrix_source=c-elegans-undirected_nb_phases=20_selection_strength=0.2_symmetry_breaking=0.75_time_steps=200000000_type=simulation.csv};
  \end{groupplot}
  \end{scope}
  ...
  \begin{scope}[shift={(-2,-7)}]
    ...
    \addplot [magenta] table[y=order_parameter] {../../data/processed/timeseries_statistics/B_factor=1.5_adj_matrix_source=c-elegans_nb_phases=20_selection_strength=0.2_symmetry_breaking=0.75_time_steps=800000.csv};
    \end{axis}
    \begin{axis}[
      name=timeseries,
      width=0.35\textwidth,
    ...
    \addplot table [y=communicative_fraction, meta=game_type] {../../data/processed/timeseries_statistics/B_factor=1.5_adj_matrix_source=c-elegans_nb_phases=20_selection_strength=0.2_symmetry_breaking=0.75_time_steps=800000.csv};
    \end{axis}
  ...
  \begin{axis}[
    ...
    \pgfplotsforeachungrouped\tablename in {../../data/processed/timeseries_statistics/B_factor=1.5_adj_matrix_source=well-mixed_nb_phases=20_selection_strength=0.2_symmetry_breaking=0.75_time_steps=800000.csv,../../data/processed/timeseries_statistics/B_factor=1.5_adj_matrix_source=c-elegans_nb_phases=20_selection_strength=0.2_symmetry_breaking=0.75_time_steps=800000.csv} {
      % Read table
