...
\begin{tikzpicture}
  ...
  \begin{scope}[shift={(-2,-7)}]
    ...
    \addplot [magenta] table[y=order_parameter] {../../../data/processed/timeseries_statistics/B_to_c=1.5_adj_matrix_source=c-elegans_beta_to_B=0.95_cost=0.1_early_cutoff_fraction=0.1_mutation_rate=0.0001_nb_phases=20_only_mixed_games=true_selection_strength=0.2_symmetry_breaking=0.75_time_steps=8000000.csv};
    \end{axis}
    \begin{axis}[
      name=timeseries,
      width=0.35\textwidth,
  ...
  \begin{axis}[
    ...
    \pgfplotsforeachungrouped\tablename in {../../../data/processed/timeseries_statistics/B_to_c=1.5_adj_matrix_source=c-elegans_beta_to_B=0.95_cost=0.1_early_cutoff_fraction=0.1_mutation_rate=0.0001_nb_phases=20_only_mixed_games=true_selection_strength=0.2_symmetry_breaking=0.75_time_steps=8000000.csv} {
      % Read table
