...
\abstract{
  ...
  of synchronized and disordered populations.
  These states have been observed
  in brain systems~\citep{santos2017chimera,bansal2019cognitive},
  ...
  but a moderately large chimera-like index ($\xi \approx \num{0.13}$).
  % General context
...
Next, we seek to understand the types of games being played
...
the symmetry is broken according to the following order
\begin{equation}
\begin{bNiceMatrix}[first-col,first-row,hvlines]
  & C & N \\
  C & 2 & 3 \\
...
wherein the two columns are swapped.
...
Note that an edge's game type is determined solely
