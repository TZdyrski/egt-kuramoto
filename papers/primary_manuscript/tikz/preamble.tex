...
\pgfplotsset{
  ...
  allCommunicative/.style={fill=lightgray,draw=lightgray},
  allNoncommunicative/.style={fill=darkgray,draw=darkgray},
  disconnectedSynchronizedPopulations/.style={fill=black,draw=black},
}
...
% Source: https://tex.stackexchange.com/a/699653
\ExplSyntaxOn
\NewExpandableDocumentCommand{\getNth}{mmmm}
  {
    % #1 string, #2 separator, #3 index
		\seq_set_split:Nne \l_tmpa_seq { #3 } { #2 }
		\edef #1 {\seq_item:Nn \l_tmpa_seq { #4 }}
  }
