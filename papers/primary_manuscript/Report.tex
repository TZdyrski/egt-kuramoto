...
and has a practical maximum of \num{0.08}~\cite{shanahan2010metastable}.
...
$\lambda = 1/4 = \num{0.25}$~\cite{shanahan2010metastable}.
A slightly more realistic upper bound
occurs when the system exhibits each possible $\rho_m \in [0,1]$
uniformly at random;
then, the upper bound becomes the variance of the continuous uniform
distribution,
$\lambda = 1/12 \approx \num{0.08}$~\cite{shanahan2010metastable}.
%TC:endignore
