...
in section 4 of the appendix for \citet{tripp2022evolutionary}
with an arbitrary asymmetry $\alpha$.
That derivation carries through until equation 16,
where we make the small correction of replacing
...
\end{aligned}
\end{equation}
where strategy $F=(N,\phi_k)$, strategy $E=(C,\phi_j)$,
and $k \in [0,m-1]$ is the number of communicative strategies $C$.

Now, using the new $\alpha$-dependent payoff functions gives
\begin{align}
