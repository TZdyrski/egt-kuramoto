...
The addition of these self-loops effectively decreases the probability
that a selected birth-node reproduces by $1/n_{\text{out}}$,
where $n_{\text{out}}$ is the out-degree of the birth-node without the
added self-loop.
Therefore, the introduction of self-loops slightly biases
reproduction to nodes with higher numbers of out-neighbors.
\end{LineLabel}
