  ...
  \begin{groupplot}[
    ...
    \nextgroupplot[xticklabel=\empty, ymin=0.99, ymax=1.0, height=3cm, blue,
      yticklabel style={/pgf/number format/.cd,precision=3}
        ...
        \pgfplotstableread{../../data/processed/gametype/B_factor=1.5_adj_matrix_source=well-mixed_nb_phases=20_selection_strength=0.2_time_steps=8000000.csv}{\loadtable}
    ...
    \nextgroupplot
      ...
      \nextgroupplot
        % Note: this table names must appear in the `\tablename` loop below
        \pgfplotstableread{../../data/processed/gametype/B_factor=1.5_adj_matrix_source=c-elegans_nb_phases=20_selection_strength=0.2_time_steps=8000000.csv}\loadtable
        \pgfplotstableforeachcolumn\loadtable\as\col
        {
          \ifnum\pgfplotstablecol=0\else%
            \expandafter\addplot\expandafter[\col,ybar stacked,draw=none] table[x=asymmetry, y=\col] {\loadtable};
    ...
    \begin{axis}[
      ...
      \pgfplotsforeachungrouped\tablename in {../../data/processed/gametype/B_factor=1.5_adj_matrix_source=well-mixed_nb_phases=20_selection_strength=0.2_time_steps=8000000.csv,../../data/processed/gametype/B_factor=1.5_adj_matrix_source=c-elegans_nb_phases=20_selection_strength=0.2_time_steps=8000000.csv} {
        % Read table
