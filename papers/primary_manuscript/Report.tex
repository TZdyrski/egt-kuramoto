...
Instead, non-synchronized game types dominate,
...
respectively).
This is likely due to the decreased average degree
of the \gls{celegans} connectome's non-complete graph.
...
to each group containing between \numrange{8}{12} players,
...
in plurality game type~\cref{fig:game-type_celegans-full}.
